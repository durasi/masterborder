...
export const ru: Translations = {
  ...
  form: {
    ...
    sampleProductDescription: "Двойной кошелёк из натуральной воловьей кожи, хромового дубления, 4 отделения для карт и карман для монет. Ручная работа с применением традиционных техник выделки кожи.",
  ...
  example: {
    bannerTitle: "Это предварительно вычисленный пример анализа",
    bannerBody: "Реальный вывод Opus 4.7 из живого запуска — заморожен здесь, чтобы вы могли увидеть продукт без расхода кредитов API.",
    ctaRunYourOwn: "Запустите свой",
    deepDiveDisabled: "Подробный анализ отключён для примеров — запустите свой анализ, чтобы пообщаться с агентом.",
    footerNote: "Пример анализа — предварительно вычислен. Запустите свой анализ с главной страницы для получения актуального отчёта.",
  },
