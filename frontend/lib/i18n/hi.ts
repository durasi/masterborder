...
export const hi: Translations = {
  ...
  example: {
    bannerTitle: "यह एक पूर्व-गणित उदाहरण विश्लेषण है",
    bannerBody: "लाइव रन से वास्तविक Opus 4.7 आउटपुट — यहां फ्रीज़ किया गया ताकि आप API क्रेडिट खर्च किए बिना उत्पाद देख सकें।",
    ctaRunYourOwn: "अपना चलाएं",
    deepDiveDisabled: "उदाहरणों पर डीप-डाइव अक्षम है — एजेंट से बात करने के लिए अपना विश्लेषण चलाएं।",
    footerNote: "उदाहरण विश्लेषण — पूर्व-गणित। ताज़ा रिपोर्ट के लिए होम पेज से अपना विश्लेषण चलाएं।",
  },
